...
<html lang="en">
  <head>
    ...
    <title>Internet Banking - BCC</title>
    ...
    <!-- full calendar css-->
    <link href="resources/NiceAdmin/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
	<link href="resources/NiceAdmin/assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
    <!-- easy pie chart-->
    <link href="resources/NiceAdmin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <!-- owl carousel -->
    <link rel="stylesheet" href="resources/NiceAdmin/css/owl.carousel.css" type="text/css">
	<link href="resources/NiceAdmin/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
    <!-- Custom styles -->
	...
	<link href="resources/NiceAdmin/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">BCC <span class="lite">Bank</span></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="resources/NiceAdmin/img/dilma.jpg">
                            </span>
                            <span class="username">Dilma Rouseff</span>
                            <b class="caret"></b>
                        </a>
...
<!--                             </li> -->
                            <li>
                                <a href="login.html"><i class="icon_key_alt"></i> Sair do Sistema</a>
                            </li>
<!--                             <li> -->
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <span>BCC Cartões</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="form_component.html">Extratos</a></li>                          
                          <li><a class="" href="form_validation.html">Limite Disponível</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="general.html">Pagamentos</a></li>
                          <li><a class="" href="buttons.html">Transferências</a></li>
                          <li><a class="" href="grids.html">Celulares</a></li>
                      </ul>
                  </li>
                  <li>
            ...
            <div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box blue-bg">
						...
						<div class="count">R$ 3.674, 00</div>
						<div class="title">Saldo Atual (Conta Corrente)</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="count"> R$ 2.200, 00</div>
						<div class="title">Poupança</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->	
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box dark-bg">
						...
						<div class="count"> R$ 853</div>
						<div class="title">Lançamentos Futuros</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
...
<!--            </div>   -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="resources/NiceAdmin/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="resources/NiceAdmin/img/India.png" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="resources/NiceAdmin/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="resources/NiceAdmin/img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>                                
                              </div>
                            </div>
  ...
  <!-- container section start -->
    ...
    <script type="text/javascript" src="resources/NiceAdmin/js/jquery-ui-1.9.2.custom.min.js"></script>
    <!-- bootstrap -->
    ...
    <script src="resources/NiceAdmin/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="resources/NiceAdmin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="resources/NiceAdmin/js/owl.carousel.js" ></script>
    <!-- jQuery full calendar -->
    <<script src="resources/NiceAdmin/js/fullcalendar.min.js"></script> <!-- Full Google Calendar - Calendar -->
	<script src="resources/NiceAdmin/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
